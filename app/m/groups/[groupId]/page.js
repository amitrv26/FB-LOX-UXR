    ...
    posts: [
      {
        ...
        featuredComment: {
          ...
          text: "PM'd! I've got an Eleven with Eggos chase in mint condition - would you do a straight trade? Can send pics.",
          time: "1h",
          reactions: { like: 8 },
          replies: [],
          replyCount: 0,
      ...
      },
      {
        ...
        featuredComment: {
          ...
          text: "Count me in! Bringing about 20 Marvel exclusives I need to offload. Does anyone have the Disney Parks Haunted Mansion set? Been hunting for months.",
          time: "3h",
          reactions: { like: 15 },
          replies: [],
          replyCount: 0,
      ...
      },
      {
        ...
        featuredComment: {
          ...
          text: "$55 for that set is a solid deal — I paid $72 for mine on eBay last year and the box was way worse. I'd jump on it if I were you.",
          time: "7h",
          reactions: { like: 22 },
          replies: [],
          replyCount: 0,
    ...
    posts: [
      {
        ...
        featuredComment: {
          ...
          text: "Would you do $35 for just the sealed Monopoly? I can meet in SoHo this weekend — I'm in the West Village so that's easy for me.",
          time: "45m",
          reactions: { like: 5 },
          replies: [],
          replyCount: 0,
      ...
      },
      {
        ...
        featuredComment: {
          ...
          text: "Wait — Netflix launch exclusives?? Those are nearly impossible to find now. Can you DM me first dibs on those before you list publicly? Happy to pay fair market.",
          time: "2h",
          reactions: { like: 28 },
          replies: [],
          replyCount: 0,
      ...
      },
      {
        ...
        featuredComment: {
          ...
          text: "I've got a signed 8x10 from NYCC 2023 — Joe signed it right in front of me so I can verify authenticity. DM me if you want pics and a price.",
          time: "5h",
          reactions: { like: 11 },
          replies: [],
          replyCount: 0,
    ...
    posts: [
      {
        ...
        featuredComment: {
          ...
          text: "This set goes for $250+ on BrickLink now that it's retired. Would you consider $170? I can pick up in Astoria today if that works.",
          time: "30m",
          reactions: { like: 12 },
          replies: [],
          replyCount: 0,
      ...
      },
      {
        ...
        featuredComment: {
          ...
          text: "3,200 pieces?! The detail on that lab entrance is ridiculous. If you ever sell instructions for this I'd buy them immediately — seriously, name your price.",
          time: "3h",
          reactions: { like: 45 },
          replies: [],
          replyCount: 0,
      ...
      },
      {
        ...
        featuredComment: {
          ...
          text: "I built a Creel House from BrickLink instructions last month! It came out pretty good. Would sell it for $85 — DMing you pics now so you can decide.",
          time: "8h",
          reactions: { like: 6 },
          replies: [],
          replyCount: 0,
    ...
    posts: [
      {
        ...
        featuredComment: {
          ...
          text: "Just left there — they still have a ton! Grabbed 8 Funkos for $32 total. The Demogorgon and Eleven ones were already gone though, so hurry if you want those.",
          time: "15m",
          reactions: { like: 34 },
          replies: [],
          replyCount: 0,
      ...
      },
      {
        ...
        featuredComment: {
          ...
          text: "The Annex on W 39th on weekends is a goldmine — go early though, the good stuff gets snatched up by 10am. Also bookmark estatesales.net for Brooklyn listings, that's how I found a box of sealed ST promo stuff last month for $20.",
          time: "2h",
          reactions: { like: 19 },
          replies: [],
          replyCount: 0,
      ...
      },
      {
        ...
        featuredComment: {
          ...
          text: "That acrylic display case alone is probably worth $15-20. Is the Joyce dispenser included? I've been looking for that one for ages — it's the only one I'm missing.",
          time: "6h",
          reactions: { like: 7 },
          replies: [],
          replyCount: 0,
