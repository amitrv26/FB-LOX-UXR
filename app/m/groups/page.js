...
I want to plan a watch party with friends and need to know when to book the day off work! 📺🍿`,
    ...
    featuredComment: {
      ...
      text: "Netflix confirmed the finale drops November 15th! Volume 1 comes out first, then Volume 2 a week later. Already took the day off! 🎉",
      time: "1h",
      reactions: { like: 89 },
      replies: [],
      replyCount: 0,
...
I work remotely so I'm looking for cafes with good wifi, great coffee, and a nice atmosphere to work from. Bonus points if they have outdoor seating for warmer days!`,
    ...
    featuredComment: {
      ...
      text: "Definitely check out Tandem Coffee Roasters! Great wifi, amazing pastries, and they have a beautiful outdoor patio. Speckled Ax is also fantastic for working.",
      time: "3h",
      reactions: { like: 12 },
      replies: [],
      replyCount: 0,
...
Looking for easy DIY ideas that don't require too many supplies. Bonus points for kid-friendly crafts we can do as a family!`,
    ...
    featuredComment: {
      ...
      text: "Paint the tips gold or silver and arrange them in a wooden bowl with some cinnamon sticks and dried oranges. Super easy and smells amazing! Kids love the painting part 🎨",
      time: "6h",
      reactions: { like: 45 },
      replies: [],
      replyCount: 0,
...
What streaming services do you all use? Looking for something reliable that won't break the bank. Sunday Ticket worth it?`,
    ...
    featuredComment: {
      ...
      text: "YouTube TV is the best option imo. Gets you all the major networks plus NFL Network. Sunday Ticket is worth it if you're out of market and follow a specific team.",
      time: "10h",
      reactions: { like: 34 },
      replies: [],
      replyCount: 0,
