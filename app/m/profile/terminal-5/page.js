...
const profileData = {
  name: "Terminal 5",
  verified: true,
  username: "terminal5nyc",
  description: "Three-level concert hall in Hell's Kitchen, NYC. 3,000 capacity across multiple floors. The biggest names in music, dance, and culture — every week.",
  recommendedPercent: "87",
  priceRange: "$$",
  followers: "85K",
  following: "198",
  coverImage: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800&h=400&fit=crop",
  profileImage: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=200&h=200&fit=crop",
};

const postsData = [
  {
    id: "post-1",
    author: { name: "Terminal 5", verified: true, date: "5h" },
    text: "🎧 THIS FRIDAY: Fred Again.. takes over all three floors of Terminal 5 for an unforgettable night of live electronic music. Very limited tickets remain — don't sleep on this one, NYC!",
  ...
  {
    id: "post-2",
    author: { name: "Terminal 5", verified: true, date: "2d" },
    text: "Three floors. One incredible night. 🔊 Last weekend's Disclosure show had every level of Terminal 5 shaking. Thank you NYC for the energy!",
    image: "https://images.unsplash.com/photo-1571266028243-e4733b0f0bb0?w=800&h=450&fit=crop",
  ...
  {
    id: "post-3",
    author: { name: "Terminal 5", verified: true, date: "6d" },
    text: "Our rooftop bar is officially open for the season! 🍹 Come early before shows and enjoy the Hell's Kitchen skyline with craft cocktails. Nothing beats pre-show vibes at T5.",
  ...
  {
    id: "post-4",
    author: { name: "Terminal 5", verified: true, date: "1w" },
    text: "From ODESZA to LCD Soundsystem to Khruangbin — Terminal 5 has hosted some of the biggest shows in NYC. What artist do you want to see on our stage next? Drop your picks below! 👇",
...
const photoGalleryImages = [
  ...
  "https://images.unsplash.com/photo-1575444758702-4a6b9222c016?w=400&h=400&fit=crop",
...
const similarPagesData = [
  ...
  { id: 'sp3', name: 'Irving Plaza', followers: '120K', image: 'https://images.unsplash.com/photo-1506157786151-b8491531f063?w=400&h=400&fit=crop' },
];
...
export default function Terminal5Profile() {
    ...
    <div style={{ background: '#fff', minHeight: '100vh', maxWidth: '500px', margin: '0 auto', paddingBottom: '100px' }}>
      <main>
            ...
            <div style={{ background: '#fff' }}>
              <div style={{ padding: '12px' }}>
                ...
                <div onClick={() => setShowReviewsSheet(true)} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '0', cursor: 'pointer' }}>
                  ...
                  <span style={{ fontSize: '15px', fontWeight: '600', lineHeight: '20px', color: '#080809', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>87% recommend (4,567 reviews)</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '0' }}>
                  ...
                  <span style={{ fontSize: '15px', fontWeight: '600', lineHeight: '20px', color: '#080809', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>Open now · Closes 3:00 AM</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', padding: '0' }}>
                  ...
                  <span style={{ fontSize: '15px', fontWeight: '600', lineHeight: '20px', color: '#080809', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif', paddingTop: '10px' }}>610 W 56th St, New York, NY 10019</span>
                </div>
              </div>
              <div style={{ padding: '12px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '0' }}>
                  ...
                  <span style={{ fontSize: '15px', fontWeight: '600', lineHeight: '20px', color: '#080809', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>terminal5nyc.com</span>
                </div>
              </div>
            </div>
        ...
        {activeTab === "Photos" && (
          <div style={{ background: '#fff' }}>
            <div style={{ padding: '12px' }}>
              <h2 style={{ fontSize: '17px', fontWeight: '700', lineHeight: '22px', color: '#080809', margin: 0, fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>Terminal 5&apos;s photos</h2>
            </div>
      ...
      <UpsellBottomSheet isOpen={showFollowPrompt} onClose={() => setShowFollowPrompt(false)} type="follow" entityName="Terminal 5" />
