...
const profileData = {
  ...
  description: "All's fair in love and poetry... New album THE CALPURNIA SESSIONS.\nOut Now 🎵",
  followers: "80M",
  following: "4",
  coverImage: "/images/profile/finn-cp.jpg",
...
const aboutData = {
  basicInfo: [
    { icon: "app-instagram-outline", label: "finnwolfhard" },
    { icon: "app-threads-outline", label: "the.calpurnia" },
    { icon: "app-tiktok-outline", label: "calpurniaband" },
    { icon: "link-outline", label: "calpurnia.com" },
  ],
  exploreMore: [
    { label: "Stranger Things Fan Club" },
    { label: "Calpurnia" },
  ],
  listening: ["The Aubreys", "Mac DeMarco", "Twin Peaks"],
  watching: ["Stranger Things", "IT"],
};

// Sample posts data - using profileData.profileImage for avatars
const postsData = [
  {
  ...
  },
  {
    ...
    text: "Hell of a Summer is now streaming! So proud of this project. Link in bio 🎬",
    image: "/images/profile/finn-post-3.jpg",
      ...
      <main>
        ...
        <div style={{ 
          ...
          <div style={{ padding: '0 12px 16px' }}>
            ...
            {/* Social Links - FDS List Cells */}
            {aboutData.basicInfo.map((item, idx) => (
              <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '0' }}>
                <div style={{ padding: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <IconInline name={item.icon} size={24} color="primary" />
                </div>
                <span style={{ fontSize: '15px', fontWeight: '600', lineHeight: '20px', letterSpacing: '-0.24px', color: '#080809', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>
                  {item.label}
                </span>
              </div>
            ))}
          ...
          <div style={{ padding: '0 12px 16px' }}>
            ...
            {aboutData.exploreMore.map((item, idx) => (
              <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '0' }}>
                <div style={{ padding: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <IconInline name="magnifying-glass-outline" size={24} color="primary" />
                </div>
                <span style={{ fontSize: '15px', fontWeight: '400', lineHeight: '20px', letterSpacing: '-0.24px', color: '#080809', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>
                  {item.label}
                </span>
              </div>
            ))}
          ...
          <div style={{ padding: '0 12px 16px' }}>
            ...
            {aboutData.listening.map((item, idx) => (
              <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '0' }}>
                <div style={{ padding: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <IconInline name="music-outline" size={24} color="primary" />
                </div>
                <span style={{ fontSize: '15px', fontWeight: '400', lineHeight: '20px', letterSpacing: '-0.24px', color: '#080809', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>
                  {item}
                </span>
          ...
          <div style={{ padding: '0 12px 16px' }}>
            ...
            {aboutData.watching.map((item, idx) => (
              <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '0' }}>
                <div style={{ padding: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <IconInline name="video-outline" size={24} color="primary" />
                </div>
                <span style={{ fontSize: '15px', fontWeight: '400', lineHeight: '20px', letterSpacing: '-0.24px', color: '#080809', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>
                  {item}
                </span>
