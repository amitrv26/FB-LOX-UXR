...
const profileData = {
  name: "Brooklyn Steel",
  verified: true,
  username: "brooklynsteel",
  description: "Williamsburg's premier live music venue. 1,800 capacity. Incredible sound. Unforgettable shows in the heart of Brooklyn, NY.",
  recommendedPercent: "92",
  priceRange: "$$",
  followers: "95K",
  following: "186",
  coverImage: "https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?w=800&h=400&fit=crop",
  profileImage: "https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?w=200&h=200&fit=crop",
};

const postsData = [
  {
    id: "post-1",
    author: { name: "Brooklyn Steel", verified: true, date: "4h" },
    text: "🎸 TONIGHT: Fontaines D.C. bring their explosive live show to Brooklyn Steel! Doors at 7PM, show at 8PM. A few tickets remain at the box office. Don't miss this one, Williamsburg!",
  ...
  {
    id: "post-2",
    author: { name: "Brooklyn Steel", verified: true, date: "2d" },
    text: "Last night's Japanese Breakfast show was pure magic ✨ Thank you Michelle and the whole band for an unforgettable evening. Brooklyn, you showed up!",
  ...
  {
    id: "post-3",
    author: { name: "Brooklyn Steel", verified: true, date: "5d" },
    text: "Our sound system just got a major upgrade 🔊 State-of-the-art L-Acoustics rig installed this week. Come hear the difference at this weekend's shows!",
  ...
  {
    id: "post-4",
    author: { name: "Brooklyn Steel", verified: true, date: "1w" },
    text: "Who's ready for an incredible spring lineup? 🌸 We've got shows every night this month — from indie to electronic to hip-hop. Check our schedule and grab tickets before they're gone!",
...
export default function BrooklynSteelProfile() {
    ...
    <div style={{ background: '#fff', minHeight: '100vh', maxWidth: '500px', margin: '0 auto', paddingBottom: '100px' }}>
      <main>
            ...
            <div style={{ background: '#fff' }}>
              <div style={{ padding: '12px' }}>
                ...
                <div onClick={() => setShowReviewsSheet(true)} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '0', cursor: 'pointer' }}>
                  ...
                  <span style={{ fontSize: '15px', fontWeight: '600', lineHeight: '20px', color: '#080809', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>92% recommend (3,891 reviews)</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '0' }}>
                  ...
                  <span style={{ fontSize: '15px', fontWeight: '600', lineHeight: '20px', color: '#080809', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>Open now · Closes 1:00 AM</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', padding: '0' }}>
                  ...
                  <span style={{ fontSize: '15px', fontWeight: '600', lineHeight: '20px', color: '#080809', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif', paddingTop: '10px' }}>319 Frost St, Brooklyn, NY 11222</span>
                </div>
              </div>
              ...
              <div style={{ padding: '12px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '0' }}>
                  ...
                  <span style={{ fontSize: '15px', fontWeight: '600', lineHeight: '20px', color: '#080809', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>bfrooklyn.steel</span>
                </div>
              </div>
            </div>
        ...
        {activeTab === "Photos" && (
          <div style={{ background: '#fff' }}>
            <div style={{ padding: '12px' }}>
              <h2 style={{ fontSize: '17px', fontWeight: '700', lineHeight: '22px', color: '#080809', margin: 0, fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>Brooklyn Steel&apos;s photos</h2>
            </div>
      ...
      <UpsellBottomSheet isOpen={showFollowPrompt} onClose={() => setShowFollowPrompt(false)} type="follow" entityName="Brooklyn Steel" />
