...
// Profile data for Rio Theatre (post author)
const profileData = {
  name: "Rio Theatre",
  verified: true,
  username: "riotheatre",
...
// Post data - Rio Theatre announcing the Stranger Things finale event
// Matches the post on the profile page exactly
const postData = {
  id: "stranger-things-finale",
  aiGenerated: false,
  body: `🎬 STRANGER THINGS SERIES FINALE - LIVE AT THE RIO! 🎬
...
// Comments data - Rio Theatre specific (26 total comments)
const commentsData = [
  {
    id: "comment-1",
    author: {
    ...
    text: "OMG FINN IS COMING?! I've been going to the Rio since I was a kid and this is literally the best thing ever!! Already got my tickets 🎟️",
    time: "1h",
    reactions: { like: 89 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "This is incredible! The Rio is the perfect venue for this - that vintage theatre vibe matches Stranger Things so well. Can't wait!",
    time: "1h",
    reactions: { like: 67 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "I'm literally crying right now 😭 Been watching this show since Season 1 and to see it end at my favorite local theatre with a hometown actor... this is everything!",
    time: "58m",
    reactions: { like: 124 },
    replies: [],
    replyCount: 0,
  ...
  },
  {
    ...
    text: "The Rio always does the coolest events! Remember when they did the 80s marathon last year? This is going to be even better!",
    time: "42m",
    reactions: { like: 56 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "Does anyone know if there will be merch available at the event? I'd love to get something signed!",
    time: "38m",
    reactions: { like: 23 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "Thanks everyone for the incredible response! 🙏 Yes, we'll have exclusive Stranger Things x Rio Theatre merch available at the event. See you there!",
    time: "35m",
    reactions: { like: 234 },
    replies: [],
    replyCount: 0,
  ...
  },
  {
    ...
    text: "Flying in from Seattle for this! Worth the trip 100%",
    time: "30m",
    reactions: { like: 45 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "My kids are going to lose their minds when I tell them about this! Best surprise ever 🎉",
    time: "28m",
    reactions: { like: 34 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "Vancouver represent! So proud this is happening in our city 🇨🇦",
    time: "25m",
    reactions: { like: 78 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "Anyone want to do a group costume? Thinking we could go as the whole gang!",
    time: "22m",
    reactions: { like: 19 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "I've never been to the Rio before but this is definitely going to be my first time! Any tips?",
    time: "20m",
    reactions: { like: 12 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "The Upside Down is coming to East Van! 🔴🔵",
    time: "18m",
    reactions: { like: 45 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "Bringing my Eleven costume from Halloween - hope others dress up too!",
    time: "15m",
    reactions: { like: 67 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "Will there be Eggo waffles at the concession? 😂🧇",
    time: "14m",
    reactions: { like: 89 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "This theatre has such good energy. Perfect place to say goodbye to the show 💔",
    time: "12m",
    reactions: { like: 38 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "Been waiting for this moment since 2016. Not ready for it to end but so glad it's happening here!",
    time: "10m",
    reactions: { like: 52 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "Anyone know what time we should line up to get good seats?",
    time: "8m",
    reactions: { like: 15 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "This is why I love Vancouver. Things like this just don't happen anywhere else!",
    time: "7m",
    reactions: { like: 41 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "Got my ticket! Section B, Row 5. See everyone there! 🎬",
    time: "6m",
    reactions: { like: 28 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "The Q&A is going to be so emotional. Bring tissues everyone 😢",
    time: "5m",
    reactions: { like: 33 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "Stranger Things + The Rio = literally the perfect combination ❤️",
    time: "4m",
    reactions: { like: 47 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "Can't believe Finn is doing this for his hometown. What a legend!",
    time: "3m",
    reactions: { like: 61 },
    replies: [],
    replyCount: 0,
...
// Stranger Things merch listings for marketplace grid
const merchListings = [
  {
    id: 1,
    title: "Stranger Things Hellfire Club Shirt",
    price: "$25",
    location: "Vancouver · 2 mi away",
    image: "/images/stranger-things-assets/images/marketplace/funko-pop.jpg",
  },
  {
    id: 2,
    title: "Eleven Funko Pop Figure",
    price: "$18",
    location: "Vancouver · 3 mi away",
    image: "/images/stranger-things-assets/images/marketplace/funko-pop-2.jpg",
  },
  {
    id: 3,
    title: "Stranger Things Season 5 Poster",
    price: "$12",
    location: "Vancouver · 1 mi away",
    image: "/images/stranger-things-assets/images/marketplace/lego-creel-house.jpg",
  },
  {
    id: 4,
    title: "Demogorgon Plush Toy",
    price: "$30",
    location: "Vancouver · 5 mi away",
