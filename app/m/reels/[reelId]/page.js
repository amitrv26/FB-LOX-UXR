...
const reelsCommentsData = [
  {
    ...
    text: "bro when millie started talking about eleven's last scene i literally had to pause this and collect myself 😭😭",
    time: "2d",
    reactions: { like: 67 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "noah is SO bad at hiding spoilers look at his face when they mention the upside down finale 💀 he knows something",
    time: "2d",
    reactions: { like: 67 },
    replies: [
      {
        ...
        text: "NO FR he literally looked at the camera like 👁️👄👁️ someone take his phone away before he posts about it",
        time: "1h",
        reactions: { love: 146 },
      }
    ],
  ...
  },
  {
    ...
    text: "i started watching this show when i was 9 and now it's ending while i'm in high school i am NOT okay rn",
    time: "3d",
    reactions: { like: 234 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "hold on rewind that part where millie says 'the mindflayer isn't what we think it is' EXCUSE ME??? theories in the replies go",
    time: "4d",
    reactions: { like: 89 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "these two were literally children in season 1 and now they're out here giving the most mature interviews i've ever seen 🥺 im so proud of them",
    time: "5d",
    reactions: { like: 156 },
    replies: [],
    replyCount: 0,
  },
  {
    ...
    text: "the way they keep finishing each other's sentences in this interview you can tell they're actually best friends irl and not just doing it for press",
    time: "1w",
    reactions: { like: 78 },
    replies: [],
    replyCount: 0,
