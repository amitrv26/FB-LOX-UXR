...
// Format reaction count for display (e.g., 21100 -> "21.1K")
...
// Illustration source - preloaded via HTML link rel="preload" in layout.js
const ILLUSTRATION_SRC = "/illustrations/reactions.png";
...
const LikeSheet = ({ 
  ...
  const [imageLoaded, setImageLoaded] = useState(() => isImageCached(ILLUSTRATION_SRC));
  ...
  useEffect(() => {
    if (isImageCached(ILLUSTRATION_SRC)) {
      setImageLoaded(true);
    } else {
    ...
    <>
      ...
      >
        ...
        <div style={{ 
          ...
          {/* Illustration - fixed height container to prevent layout shift */}
          <div style={{
            display: 'flex',
            ...
            marginTop: '4px',
            marginBottom: '12px',
            minHeight: '100px' // Reserve space for illustration
          }}>
            <img 
          ...
          <h2 style={{
            ...
            {formatReactionCount(reactionCount)} reactions and counting
          </h2>
