/**
 * Framer Motion transition variants using StyleX tokens
 * These can be used with motion components for animations
 */

// Animation timing values (for Framer Motion, use numbers not ms strings)
export const fds = {
  animation: {
